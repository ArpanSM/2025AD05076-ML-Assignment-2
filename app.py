...
def load_model(artifact_name: str):
    model = joblib.load(MODEL_DIR / artifact_name)
    return restore_legacy_attributes(model)


def restore_legacy_attributes(model):
    """Bridge Logistic Regression artifacts between recent and older scikit-learn versions."""
